...
class Product():
   ...
   #     sql = 'INSERT INTO PRODUCT VALUES ()'
    ...
    def update_product_withImage(input):
        sql = 'UPDATE PRODUCT SET PNAME=:name, PRICE=:price, CATEGORY=:category, PDESC=:description, PNUM=:num, PIMAGE=:editimage WHERE PID=:pid'
        DB.execute_input(DB.prepare(sql), input)
        DB.commit()
